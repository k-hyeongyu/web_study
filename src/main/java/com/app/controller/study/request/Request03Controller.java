...
@Controller
@RequestMapping("/request03")  //클래스 전체에 대한 URL prefix 설정
public class Request03Controller {

    private final BoardController boardController;

    Request03Controller(BoardController boardController) {
...
// http://localhost:8080/request03/param5?p1=10&p2=20
	...
	@GetMapping("/param8")  //get 단순조회, 읽기  초기화면 연결
	public String param8() {
		System.out.println("request03/param8 GET 요청");
		return "req/param/param8";
	}
	
	@PostMapping("/param8") // POST 데이터 읽기,쓰기 전달   실제 데이터를 전달 받아서 로직 처리
	//public String param8Action(@ModelAttribute Product product) 
