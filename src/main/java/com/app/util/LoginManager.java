...
public class LoginManager {
	...
	public static void setSessionLoginUser(HttpSession session, String id) {
		session.setAttribute(SESSION_LOGIN_USER_KEY, id);
	}

	public static void setSessionLoginUser(HttpServletRequest request, String id) {
		setSessionLoginUser(request.getSession(), id);
	}
